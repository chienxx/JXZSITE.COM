...
## 挂载 OneDrive
由于 VPS 存储空间通常有限，通常只有几十GB，若想收集大量高品质音乐显然不够。因此，可以通过挂载外部存储来“曲线救国”，实现存储扩展。详细教程可参考[文章](https://blog.jxzsite.com/blog/guide/mount-onedrive)

> [!Note] **结合 [文章](https://blog.jxzsite.com/blog/guide/mount-onedrive)**
