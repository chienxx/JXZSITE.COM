...
const toolsData: Tool[] = [
  ...
  },
  {
    ...
    category: 'macOS',
    label: 'SECURE-CHAT',
    description: 'Cross-platform instant messaging software that supports users to exchange encrypted and self-destructing messages with each other, send all types of files such as photos, movies, etc.',
