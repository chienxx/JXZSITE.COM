...
const toolsData: Tool[] = [
  ...
  },
  {
    ...
    description: 'Modern, native client with intuitive GUI tools to create, access, query & edit multiple relational databases.',
  ...
  },
  {
    ...
    category: 'macOS',
    label: 'SECURE-CHAT',
    description: 'Cross-platform instant messaging software that supports users to exchange encrypted and self-destructing messages with each other.',
  ...
  },
  {
    ...
    category: 'macOS',
    label: 'TRANSLATE-OCR',
    description: 'Use Bob for translation and OCR in any application, ready to go, simple, fast and efficient.',
  ...
  },
  {
    ...
    category: 'Web',
    label: 'FILE-TRANSFER',
    description: 'A simple file transfer tools, similar to lrzsz ( rz / sz ), and compatible with tmux.',
