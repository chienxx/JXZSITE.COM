  ...
  <div className="group w-full p-4 sm:w-1/2 transform transition-transform duration-300 ease-in-out hover:scale-105">
    <div className="relative overflow-hidden rounded-lg border border-gray-300 bg-white shadow-lg transition-shadow duration-300 dark:border-gray-600 dark:bg-gray-800">
      <div className="flex items-center space-x-4 p-4 min-h-[160px]">
        ...
        {imgSrc && (
          <Link href={href || '#'}>
            <div className="block h-24 w-24 overflow-hidden rounded-lg transition-transform duration-300 ease-in-out hover:translate-y-1 hover:scale-110">
              <Image
                alt={title}
                src={imgSrc}
      ...
      {label && (
        <div className="absolute right-3 top-3">
          <span className="inline-block rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-500 transition-all duration-300 group-hover:scale-110 group-hover:bg-green-200 dark:bg-green-900 dark:text-green-400 dark:group-hover:bg-green-800">
            {label}
          </span>
        </div>
      )}
